...
extern "C" {
    ...
    #[doc = " <returns>\"A TPCANStatus error code\"</returns>"]
    pub fn CAN_InitializeFD(Channel: u16, BitrateFD: *mut ::std::os::raw::c_char) -> u32;
}
extern "C" {
    #[doc = " <summary>"]
...
extern "C" {
    ...
    #[doc = " <returns>\"A TPCANStatus error code\"</returns>"]
    pub fn CAN_FilterMessages(Channel: u16, FromID: u32, ToID: u32, Mode: u8) -> u32;
}
extern "C" {
    #[doc = " <summary>"]
...
extern "C" {
    ...
    #[doc = " <returns>\"A TPCANStatus error code\"</returns>"]
    pub fn CAN_GetErrorText(Error: u32, Language: u16, Buffer: *mut ::std::os::raw::c_char) -> u32;
}
extern "C" {
    #[doc = " <summary>"]
    #[doc = " Finds a PCAN-Basic channel that matches with the given parameters"]
    #[doc = " </summary>"]
    #[doc = " <param name=\"Parameters\">A comma separated string contained pairs of"]
    #[doc = " parameter-name/value to be matched within a PCAN-Basic channel</param>"]
    #[doc = " <param name=\"FoundChannel\">Buffer for returning the PCAN-Basic channel,"]
    #[doc = " when found</param>"]
    #[doc = " <returns>A TPCANStatus error code</returns>"]
    pub fn CAN_LookUpChannel(
        Parameters: *mut ::std::os::raw::c_char,
        FoundChannel: *mut u16,
    ) -> u32;
}
